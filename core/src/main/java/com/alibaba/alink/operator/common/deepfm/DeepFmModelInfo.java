...
/**
 * Model info of DeepFM.
 */
public class DeepFmModelInfo {

    private int[] dim;
    private String task;
    private int vectorSize;
    private DeepFmDataFormat factors;
    ...
    public DeepFmModelInfo(List<Row> rows, TypeInformation labelType) {
        DeepFmModelData modelData = new DeepFmModelDataConverter(labelType).load(rows);
        ...
        this.factors = modelData.deepFmModel;
    }
